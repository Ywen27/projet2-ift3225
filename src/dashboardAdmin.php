...
while ($row = $users->fetch_assoc()) {
    $userIds[$row['username']] = $row['user_id'];
}
$users->data_seek(0);
...
<body>
    <div class="container">
        ...
        <h3>Salut
            ...
            </span>! Allons gérer les tâches pour tout le monde.
        </h3>
        <br>
        ...
        <form id="filterForm" method="post" action="">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th><label for="filter-username" class="col-form-label">par le nom d'utilisateur?</label></th>
                ...
                <tbody>
                    <tr>
                        <td>
                            <input type="text" class="form-control" id="filter-username" name="filter-username"
